...
const { data, refresh } = await useAsyncData('library', () =>
  api.getArticles({ published: 1, page: page.value, per_page: perPage, category: category.value || undefined })
)
  ...
  <div class="library">
    ...
    <div class="lib-header">
      <div class="lib-header-left">
        <NuxtLink to="/articles" class="lib-back label">← Writing</NuxtLink>
