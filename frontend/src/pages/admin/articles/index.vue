...
<template>
  <div>
    <div class="page-header">
      ...
      <router-link to="/admin/articles/create" class="page-btn label">写新文章</router-link>
    </div>
    ...
    <div class="data-table">
      ...
      <div v-for="a in articles" :key="a.id" class="table-row">
        <span class="table-cell table-cell--wide">
          <router-link :to="`/admin/articles/${a.id}`" class="table-title">{{ a.title }}</router-link>
        </span>
        ...
        <span class="table-cell table-actions">
          <router-link :to="`/admin/articles/${a.id}`" class="action-link">编辑</router-link>
