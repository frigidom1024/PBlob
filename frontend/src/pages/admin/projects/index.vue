...
<template>
  <div>
    <div class="page-header">
      ...
      <router-link to="/admin/projects/create" class="page-btn label">添加项目</router-link>
    </div>
    ...
    <div class="data-table">
      ...
      <div v-for="p in projects" :key="p.id" class="table-row">
        <span class="table-cell table-cell--wide">
          <router-link :to="`/admin/projects/${p.id}`" class="table-title">{{ p.title }}</router-link>
        </span>
        ...
        <span class="table-cell table-actions">
          <router-link :to="`/admin/projects/${p.id}`" class="action-link">编辑</router-link>
